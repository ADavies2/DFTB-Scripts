...
GenFile = str(raw_input('What is the name of your .gen file? '))
PoscarFile = str(raw_input('What would you like your POSCAR filed to be called? '))
...
POSCAR = open(PoscarFile, 'w') # Create a file to write to
