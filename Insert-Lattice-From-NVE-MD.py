...
# This script will input that data from each MD timestep from an NVE simulation 

import numpy as np
import csv
from itertools import islice

filename = 'md.out' # The md.out filename to collect data from
xyz_filename = 'Water-NaCl-NVE.xyz' # The .xyz file to convert

md_length = 3000 # steps
restart = 20 # restart interval
data_points = md_length//restart # number of MD data points
no_atoms = 1214 # total number of atoms 
